...
В тот период я также заметил пользу **упражнений с сокращением анального сфинктера** (упражнения Кегеля): 100–200 повторений в подходе, 3–5 подходов в день — для местного кровообращения и облегчения симптомов.
