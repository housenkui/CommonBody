...
CommonBody 不是第一家做「病友互助」的，也不是第一個分享康復經驗的網站。幾百年來，走過夜路的人一直在給後人點燈——從口耳相傳，到報刊讀者來信，再到貼吧長帖。我們想用今天的工具（網站、開源協作、審閱與免責），把這件事做得更久、更清楚、更少誤導。

**CommonBody 處在「民間病友互助」與「開源公共知識」的交叉點上**——用 21 世紀的網站和短視頻，做了一件幾百年來都在發生的事。

### 康復者教康復者

歷史上長期存在一種傳遞方式：**「走過來的人」幫「正在走的人」**。匿名戒酒會（AA）、艾滋病社群自救、各病種病友會、中國農村「同病相憐、口口相傳」——邏輯相同，只是載體從村口、病房走廊，變成了 commonbody.org。

### 個人苦難寫成公共知識

患者回憶錄、民國報刊衛生稿、孫思邈搜集民間驗方……都是把分散的經驗**匯總成可傳播的知識**。我將六次手術寫成長文再建公益站，相當於 **「一個人的病歷」變成「一群人的參考書」**——以前靠刻本與雜誌，現在靠網站。

### 非盈利的知識開源

啟蒙時代小冊子、工人互助會、開源軟體運動、維基百科——**「把有用的東西攤到多數人面前，且不以此牟利」** 這條線很長。「人類健康開源計劃」即此精神在健康經驗上的延伸。

### 中國語境裡尤其熟悉的幾件事

| 脈絡 | 與 CommonBody 的關係 |
|------|---------------------|
| 天涯、貼吧「經驗長帖」（2000 年代起） | 把散落難檢索的帖子，升級成可長期訪問的公益站 |
| 養生食療民間書寫（歷代） | 作息、飲食、排便習慣落在這條傳統裡；我們更強調醫療紅線 |
| 近年病友博主 | 更偏公益基礎設施：站點沉澱、[志願者招募](/volunteers)、長期維護 |

### 我們也要引以為戒

民間驗方有有效也有誤導；有人借「過來人」賣藥賣課；論壇帖子會沉底流失。CommonBody 以**免責聲明、非盈利、重症就醫、內容審閱**來劃清邊界。

> 手術能救急，習慣養根。重症請就醫；輕症與反覆發作者，或許能從同路人的經驗裡少踩一點坑。
